...
public class Show07 extends Activity {
	...
	public void onCreate(Bundle b0)
	{
		...
		setContentView(R.layout.show);
		 webview = (WebView) findViewById(R.id.webView1);
			...
			webview.loadUrl("file:///android_asset/AWTCheckBoxGroup/01.html");
	...
	public void onClick(View v) {
		...
		if(j == 1) {
			...
			webview.loadUrl("file:///android_asset/AWTCheckBoxGroup/02.html");
			j = 3;
		}else if (j == 3) {
			//tx.setText(R.string.arr1);
			webview.loadUrl("file:///android_asset/AWTCheckBoxGroup/03.html");
			j = 1;
		}
		}
		});

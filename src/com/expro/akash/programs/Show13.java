...
public class Show13 extends Activity {
	...
	public void onCreate(Bundle b0)
	{
		...
		setContentView(R.layout.show);
		 webview = (WebView) findViewById(R.id.webView1);
			...
			webview.loadUrl("file:///android_asset/Constructor/01.html");
...
arrow.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		if(j == 1) {
			...
			webview.loadUrl("file:///android_asset/Constructor/02.html");
			j = 3;
		}else if (j == 3) {
			//tx.setText(R.string.arr1);
			webview.loadUrl("file:///android_asset/Constructor/03.html");
			j = 4;
		}else if (j == 4) {
			//tx.setText(R.string.arr1);
			webview.loadUrl("file:///android_asset/Constructor/04.html");
			j = 1;
		}
		}
		});
